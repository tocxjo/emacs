...
#+BEGIN_SRC emacs-lisp
  ...
  (unless (boundp 'org-babel-default-header-args:emacs-lisp)
    (setq org-babel-default-header-args:emacs-lisp '((:tangle . "no"))))

  (unless (boundp 'org-babel-default-header-args:elisp)
    (defvaralias 'org-babel-default-header-args:elisp 'org-babel-default-header-args:emacs-lisp))
#+END_SRC
